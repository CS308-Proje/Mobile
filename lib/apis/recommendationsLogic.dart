  ...
  try {
    ...
    switch (recType) {
      case RecommendationType.song:
        url = Uri.parse('http://localhost:5001/based-on-song-ratings');
        break;
      case RecommendationType.album:
        url = Uri.parse('http://localhost:5001/based-on-album-ratings');
        break;
      case RecommendationType.artist:
        url = Uri.parse('http://localhost:5001/based-on-artist-ratings');
        break;
      case RecommendationType.spotify:
        url = Uri.parse('http://localhost:5001/based-on-spotify');
        break;
      case RecommendationType.temporal:
        url = Uri.parse('http://localhost:5001/based-on-temporal');
        break;
      case RecommendationType.friends:
        url = Uri.parse('http://localhost:5001/based-on-friends');
        break;
