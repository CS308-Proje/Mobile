...
class SongService {
  ...
  Future<List<Album>> fetchAlbums() async {
    ...
    final response = await http.get(
      Uri.parse('http://localhost:5001/albums'),
      headers: headers,
    );
  ...
  Future<bool> transferSongs(
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://localhost:5001/transfer-songs'),
        headers: headers,
        body: data,
      );
  ...
  Future<void> removeSong(String songId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('http://localhost:5001/songs/$songId'),
        headers: headers,
      );
  ...
  Future<void> removeAlbum(String albumId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('http://localhost:5001/albums/$albumId'),
        headers: headers,
      );
  ...
  Future<void> removeArtist(String artistId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('http://localhost:5001/artists/$artistId'),
        headers: headers,
      );
