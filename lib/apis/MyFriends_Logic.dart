...
class MyFriendsLogic {
  ...
  Future<List<Friend>> fetchUserFriends() async {
    ...
    final response = await http.get(
      Uri.parse('http://10.0.2.2:5000/friends/all'),
      headers: headers,
    );
  ...
  Future<void> removeFriendById(String friendId) async {
    ...
    final url = Uri.parse('http://10.0.2.2:5000/friends/remove/$friendId');
  ...
  Future<List<Invitation>> fetchUserInvitations() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.0.2.2:5000/invitation/getallinv'),
        headers: headers,
      );
  ...
  Future<void> updateInvitationStatus(String invitationId, String status) async {
    ...
    // Example:
    final url = Uri.parse('http://10.0.2.2:5000/invitation/update/$invitationId');
  ...
  Future<void> sendFriendRequest(String userId, String targetUserId) async {
    ...
    final url = Uri.parse('http://10.0.2.2:5000/invitation/createInvitation/$targetUserId');
