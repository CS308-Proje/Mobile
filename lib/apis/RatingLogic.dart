...
Future<void> rateItem(
  ...
  switch (ratingType) {
    case RatingType.song:
      url = Uri.parse('http://10.0.2.2:5000/rating/rateSong/$itemId');
      break;
    case RatingType.album:
      url = Uri.parse('http://10.0.2.2:5000/rating/rateAlbum/$itemId');
      break;
    case RatingType.artist:
      url = Uri.parse('http://10.0.2.2:5000/rating/rateArtist/$itemId');
      break;
    default:
